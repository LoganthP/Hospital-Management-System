...
const Doctors = () => {
    const { doctors, addDoctor, updateDoctor, deleteDoctor, theme, colors } = useHospital();
        ...
        <Layout>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <span style={{ fontSize: '13px', fontWeight: 600, color: theme === 'dark' ? '#4ade80' : '#15803d' }}>
                        {doctors.filter(d => d.availability === 'Available').length} Available
                    </span>
                </div>
                <div style={{
                    padding: '12px 20px',
                    background: theme === 'dark' ? 'rgba(245, 158, 11, 0.2)' : '#fef3c7',
                    borderRadius: '9999px',
                    display: 'flex',
                    alignItems: 'center',
                    gap: '8px',
                    ...
                    <span style={{ fontSize: '13px', fontWeight: 600, color: theme === 'dark' ? '#fbbf24' : '#b45309' }}>
                        {doctors.filter(d => d.availability === 'Busy').length} Busy
                    </span>
                </div>
                <div style={{
                    padding: '12px 20px',
                    background: theme === 'dark' ? 'rgba(156, 163, 175, 0.2)' : '#f3f4f6',
                    borderRadius: '9999px',
                    display: 'flex',
                    alignItems: 'center',
                    gap: '8px',
                    ...
                    <span style={{ fontSize: '13px', fontWeight: 600, color: theme === 'dark' ? '#d1d5db' : '#6b7280' }}>
            ...
            <div style={{
                    ...
                    return (
                        <div
                            ...
                            style={{
                                ...
                                overflow: 'hidden',
                                boxShadow: isHovered
                                    ? (theme === 'dark' ? '0 20px 40px -12px rgba(0, 0, 0, 0.5)' : '0 20px 40px -12px rgba(0, 0, 0, 0.15)')
                                    : colors.shadow,
                                border: `1px solid ${colors.border}`,
                                transition: 'all 0.3s',
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <Star
                                                ...
                                                color={star <= 4 ? '#fbbf24' : (theme === 'dark' ? '#374151' : '#e5e7eb')}
                                            />
                                        ))}
                ...
                {filteredDoctors.length === 0 && (
                    <div style={{
                        ...
                        <Stethoscope size={48} color={theme === 'dark' ? '#374151' : '#e5e7eb'} style={{ marginBottom: '12px' }} />
