                ...
                <div>
                    {result ? (
                                ...
                                <div style={{
                                    ...
                                    <ul style={{
                                        ...
                                        {result.advice.map((advice, idx) => (
                                            <li key={idx} style={{
                                                fontSize: '14px',
                                                color: theme === 'dark' ? colors.textPrimary : '#374151',
                                            }}>
                                                {advice}
                                            </li>
                                        ))}
                        ...
                        <div style={{
                            height: '100%',
                            minHeight: '400px',
                            background: theme === 'dark' ? 'rgba(31, 41, 55, 0.3)' : 'linear-gradient(135deg, #f9fafb 0%, #f3f4f6 100%)',
                            borderRadius: '20px',
                            ...
                            <div style={{
                                ...
                                <Brain size={40} color="#9333ea" style={{ opacity: 0.5 }} />
                            </div>
                            <h3 style={{
                                margin: 0,
                                fontSize: '20px',
