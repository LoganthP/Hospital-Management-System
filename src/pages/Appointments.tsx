...
const Appointments = () => {
    const { appointments, patients, doctors, addAppointment, cancelAppointment, theme, colors } = useHospital();
    ...
    const getStatusStyle = (status: string): { bg: string; color: string; icon: typeof CheckCircle } => {
        const styles: Record<string, { bg: string; color: string; icon: typeof CheckCircle }> = {
            Scheduled: {
                bg: theme === 'dark' ? 'rgba(37, 99, 235, 0.2)' : 'linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%)',
                color: theme === 'dark' ? '#60a5fa' : '#1d4ed8',
                icon: Clock
            },
            Completed: {
                bg: theme === 'dark' ? 'rgba(22, 163, 74, 0.2)' : 'linear-gradient(135deg, #dcfce7 0%, #bbf7d0 100%)',
                color: theme === 'dark' ? '#4ade80' : '#15803d',
                icon: CheckCircle
            },
            Cancelled: {
                bg: theme === 'dark' ? 'rgba(220, 38, 38, 0.2)' : 'linear-gradient(135deg, #fee2e2 0%, #fecaca 100%)',
                ...
                <div style={{
                    ...
                    <button
                        ...
                        onMouseEnter={(e) => {
                            ...
                            e.currentTarget.style.boxShadow = theme === 'dark' ? '0 10px 25px rgba(0, 0, 0, 0.4)' : '0 10px 25px rgba(37, 99, 235, 0.15)';
                        }}
                        onMouseLeave={(e) => {
            ...
            <div style={{
                ...
                {filteredAppointments.length > 0 ? (
                    ...
                    <div style={{
                        ...
                        <CalendarDays size={48} color={theme === 'dark' ? '#374151' : '#e5e7eb'} style={{ marginBottom: '12px' }} />
