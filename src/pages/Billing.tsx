...
import PaymentStatusChart from '../components/billing/PaymentStatusChart';
...
const Billing = () => {
    const { theme, colors } = useHospital();
            ...
            <div style={{
                ...
                {filteredInvoices.length > 0 ? (
                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    ...
                                    <span style={{ fontWeight: 600, color: '#9333ea', fontSize: '14px' }}>
                                        {invoice.id}
                                    </span>
                                </div>
                    ...
                    <div style={{
                        ...
                        <Receipt size={48} color={theme === 'dark' ? '#374151' : '#e5e7eb'} style={{ marginBottom: '12px' }} />
