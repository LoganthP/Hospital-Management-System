...
const Patients = () => {
    const { patients, addPatient, updatePatient, deletePatient, theme, colors } = useHospital();
                ...
                <div style={{
                    ...
                    <button
                        ...
                        onMouseEnter={(e) => {
                            ...
                            e.currentTarget.style.boxShadow = theme === 'dark' ? '0 10px 25px rgba(0, 0, 0, 0.4)' : '0 10px 25px rgba(147, 51, 234, 0.15)';
                        }}
                        onMouseLeave={(e) => {
            ...
            <div style={{
                ...
                {filteredPatients.length > 0 ? (
                    ...
                    <div style={{
                        ...
                        <Users size={48} color={theme === 'dark' ? '#374151' : '#e5e7eb'} style={{ marginBottom: '12px' }} />
