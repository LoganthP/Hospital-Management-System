...
const Header = () => {
    const { currentUser, logout, patients, doctors, theme } = useHospital();
    ...
    const getRoleBadgeStyle = (role: string) => {
        switch (role) {
            case 'Admin':
                return { backgroundColor: '#f3e8ff', color: '#7e22ce', borderColor: '#d8b4fe' }; // Purple
            case 'Doctor':
                return { backgroundColor: '#dbeafe', color: '#1d4ed8', borderColor: '#bfdbfe' }; // Blue
            case 'Patient':
                return { backgroundColor: '#dcfce7', color: '#15803d', borderColor: '#86efac' }; // Green
            default:
                return { backgroundColor: '#f3f4f6', color: '#374151', borderColor: '#e5e7eb' }; // Gray
        }
    };
                                ...
                                <div style={{ display: 'flex', gap: '8px' }}>
                                    {unreadCount > 0 && (
                                        <button
                                            ...
                                            style={{ fontSize: '12px', color: '#4f46e5', fontWeight: '500', background: 'none', border: 'none', cursor: 'pointer', padding: '4px 8px', borderRadius: '4px' }}
                                    ...
                                    {notifications.length > 0 && (
                                        <button
                                            ...
                                            style={{ fontSize: '12px', color: '#6b7280', background: 'none', border: 'none', cursor: 'pointer', padding: '4px 8px', borderRadius: '4px' }}
                                        ...
                                        {notifications.map(notification => (
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    cursor: 'pointer',
                                                    backgroundColor: !notification.read ? '#eef2ff' : 'white',
                                                    transition: 'background-color 0.2s'
                                                }}
                                                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = !notification.read ? '#e0e7ff' : '#f9fafb'}
                                                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = !notification.read ? '#eef2ff' : 'white'}
                                            >
                                                <div style={{ padding: '8px', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)', border: '1px solid #f3f4f6' }}>
                                                    {getNotificationIcon(notification.type)}
                                                </div>
                                                <div style={{ flex: 1 }}>
                                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '4px' }}>
                                                        <p style={{ margin: 0, fontSize: '14px', fontWeight: !notification.read ? '600' : '500', color: !notification.read ? '#111827' : '#374151' }}>
                                                            {notification.title}
                                                        </p>
                                                        <button
                                                            onClick={(e) => {
                                                            ...
                                                            style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '4px', borderRadius: '50%', color: '#9ca3af', display: 'flex' }}
